    ...
    <footer className="bg-slate-900 dark:bg-black text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="py-16 grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm text-slate-500">
              Servicios Informáticos Marcelo Cortés EIRL
            </p>
          </div>
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-slate-300 hover:text-[#7AA228] transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                className="w-10 h-10 bg-slate-800 hover:bg-[#7AA228] rounded-lg flex items-center justify-center text-slate-400 hover:text-white transition-all"
                aria-label="LinkedIn"
              >
        ...
        <div className="py-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500">
            © {currentYear} ItsDev. Todos los derechos reservados.
          </p>
